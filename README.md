...
```
curl -L -o /tmp/gnome-linto-0.1.0-x86_64.flatpak https://github.com/benjaminbellamy/gnome-linto/releases/download/v0.1.0/gnome-linto-0.1.0-x86_64.flatpak && flatpak install --user /tmp/gnome-linto-0.1.0-x86_64.flatpak
```
