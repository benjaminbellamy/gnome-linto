...
```
curl -L -o /tmp/gnome-linto-1.0.9-x86_64.flatpak https://github.com/benjaminbellamy/gnome-linto/releases/download/v1.0.9/gnome-linto-1.0.9-x86_64.flatpak && flatpak install --user /tmp/gnome-linto-1.0.9-x86_64.flatpak
```
