...
```
curl -L -o /tmp/gnome-linto-0.1.1-x86_64.flatpak https://github.com/benjaminbellamy/gnome-linto/releases/download/v0.1.1/gnome-linto-0.1.1-x86_64.flatpak && flatpak install --user /tmp/gnome-linto-0.1.1-x86_64.flatpak
```
